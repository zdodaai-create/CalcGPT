...
export default function ChemistryMegaCategoryPage() {
  ...
  const filteredData = useMemo(() => {
    ...
    return CHEMISTRY_DATA.map(category => ({
      ...category,
    ...
    <div className="min-h-screen bg-[#F8F9FA] pt-12 pb-20">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500 mb-10">
          ...
          <span className="text-gray-900 font-bold">Chemistry</span>
        </nav>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-gray-500 font-medium leading-relaxed">
                From basic stoichiometry and molar mass to complex thermodynamics and electrochemistry calculations. Precision tools for labs and classrooms.
              </p>
            </div>
            <div className="hidden lg:block">
               <div className="bg-blue-50 p-6 rounded-[2rem] border border-blue-100 max-w-sm">
                  <h3 className="font-bold text-blue-900 mb-2">Need a custom reaction?</h3>
                  <p className="text-blue-700/80 text-sm mb-4">Our AI Formula Forge can balance any chemical equation instantly.</p>
        ...
        <section className="mt-24 pt-16 border-t border-gray-100">
           <h2 className="text-3xl font-black text-gray-900 mb-8">Professional Chemistry Tools</h2>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                {
                  title: "IUPAC Standardized",
                  desc: "Calculations follow the latest IUPAC nomenclature and chemical standards for global compatibility."
                },
                {
                  title: "Smart Molar Mass",
                  desc: "Integrated database of atomic weights for over 118 elements to ensure high-precision results."
                },
                {
                  title: "Research Grade",
                  desc: "Tools designed to handle scientific notation, significant figures, and complex chemical equilibrium."
                }
              ].map((item, i) => (
